            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-end m-2 p-2">
                    <Link :href="route('skills.create')"
                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-500 text-white rounded-md">New Skill</link>
                </div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="skill in skills.data" :key="skill.id"
                                ...
                                <td class="px-6 py-4">
                                    <Link :href="route('skills.edit', skill.id)" class="font-medium text-blue-500
